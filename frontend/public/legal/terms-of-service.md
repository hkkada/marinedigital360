...
These Terms of Service ("Terms") constitute a legally binding agreement between you ("Client," "you," or "your") and {{COMPANY_NAME}} ("Company," "we," "us," or "our") governing your use of our website and professional services.
...
- Brand positioning and messaging services
...
- Custom marketing assets developed specifically for your project
...
- Pre-existing frameworks, templates, libraries, and tools
...
- Projects may include third-party components (stock imagery, fonts, plugins)
...
- Warranty covers bugs and errors in custom assets we develop
...
- Technical information, marketing strategies, and designs
...
- Marine industry insights and content
...
- **Commonwealth of Pennsylvania**, United States (if you are in the U.S.)
...
- Exclusive jurisdiction and venue in state and federal courts located in **Philadelphia County, Pennsylvania**
...
Any dispute arising from these Terms may be resolved through binding arbitration administered by the American Arbitration Association (AAA) under its Commercial Arbitration Rules.
...
**{{COMPANY_NAME}}**
*Transforming Marine Business Capabilities into Market-Ready Products*
