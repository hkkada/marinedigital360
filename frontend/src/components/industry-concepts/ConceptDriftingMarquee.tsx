...
function Pill({ industry }: { industry: Industry }) {
  ...
  return (
    <span className="inline-flex flex-shrink-0 items-center gap-2.5 rounded-full border border-gray-200 bg-white py-3 pl-3.5 pr-5 text-sm font-semibold whitespace-nowrap text-gray-900 transition-colors duration-300 hover:border-[#1877F2]/55">
