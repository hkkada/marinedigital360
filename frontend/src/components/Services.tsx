...
import { Card, CardTitle, CardBody, IconBox, SpotlightDots } from '@/components/shared';
...
export function Services() {
  ...
  return (
    <section id="services" className="scroll-mt-nav" ref={sectionRef} aria-labelledby="services-heading">
      ...
      <div className="pt-section pb-section-sm bg-white">
          ...
          */}
                          ...
                          >
                            <Link href={getServiceHref(service)} className="block h-full">
                              <Card variant="solid" size="lg" className="h-full">
                                <IconBox icon={Icon} surface="dark" className="mb-4 sm:mb-5" />

                                <CardTitle
                                  as="h4"
                                  className="mb-3 group-hover:text-brand-cyan transition-colors duration-300"
                                >
                                  {service.title}
                                </CardTitle>
                                ...
                                <div className="flex items-center gap-2 text-meta font-medium text-brand-cyan opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-3 px-12 py-6 bg-gradient-to-r from-[#1877F2] to-[#0D5DBF] text-white rounded-full text-body font-semibold shadow-2xl shadow-[#1877F2]/50 hover:shadow-[#1877F2]/70 transition-all"
            >
              Start Your Project
        ...
        >
          <div
            ref={whoWeAreRef}
            className="relative p-6 sm:p-10 md:p-12 bg-gradient-to-br from-brand-navy via-brand-navy-raised to-brand-navy-deep rounded-3xl overflow-hidden"
          >
            {/* Animated background — dots drift, and brighten around the pointer */}
            <SpotlightDots containerRef={whoWeAreRef} />
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <h3 className="text-h2 text-white mb-block">
                We don&apos;t just market &mdash;
                <br />
                <span className="bg-gradient-to-r from-[#00CEFA] via-[#7FF6FE] to-[#00CEFA] bg-clip-text text-transparent">
                  we productize
                </span>
              </h3>
